...
public class Utils {
    ...
    public static long toEpochSeconds(String iso) {
        ...
        int minute = ((iso.charAt(14) - '0') * 10)  +  (iso.charAt(15) - '0');
        int second = ((iso.charAt(17) - '0') * 10)  +  (iso.charAt(18) - '0');
    ...
    public static float clamp(float v) {
        ...
        if (Float.isInfinite(v) || v > 1.0f) return 1.0f;
